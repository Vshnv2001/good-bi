  ...
  return (
    <>
      ...
      <article className="max-w-xl px-4 mx-auto">
        <h1 className="text-center font-bold text-4xl mt-12 md:text-5xl">Terms of Service</h1>
        ...
        <div className="prose text-gray-800">
          ...
          <div>
            ...
            <p>
              ...
              on this page. Your continued use of GoodBI after changes are made constitutes your acceptance of the new
              Terms.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>
              All content, including text, graphics, logos, and software, is the property of GoodBI or our licensors and
          ...
          <div>
            <h2>Disclaimers</h2>
            <p>
              GoodBI is provided on an &quot;as is&quot; and &quot;as available&quot; basis. We make no warranties or
              representations
