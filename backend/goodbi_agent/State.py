...
class State(TypedDict):
    ...
    interpreted_answer: Annotated[
        str, operator.add
    ]  # Interpreted text answer, can be used in frontend
    error: str  # Error message, if any
    visualization: Annotated[str, operator.add]  # Visualization type [bar, line, etc.]
    visualization_reason: Annotated[
        str, operator.add
    ]  # Reason for the visualization type chosen
    formatted_data_for_visualization: Dict[
        str, Any
    ]  # Formatted data for visualization, sent to frontend
    kpi_suggested: Dict[str, Any]  # Suggested KPIs
